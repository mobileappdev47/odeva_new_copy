    ...
    return WillPopScope(
        ...
        child: Container(
          ...
          child: Scaffold(
              ...
              key: scaffoldKey,
              appBar: curSelected == 4 ? null:curSelected == 0 ?null :curSelected == 1 ? null: _getAppbar(),
              // drawer: _getDrawer(),
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: BottomNavigationBar(
            ...
            currentIndex: curSelected,
            //key: bottomNavigationKey,
            //backgroundColor: isDarkTheme ? colors.darkColor : colors.lightWhite,
            type: BottomNavigationBarType.fixed,
            backgroundColor: Color(0xff341069),//colors.lightWhite,
            ...
            items: [
              curSelected == 0
                ...
                //label: 'Home',
                label:"Home"/* Text('Home',style: TextStyle(color: Colors.black54))*/,
              )
                  :BottomNavigationBarItem(
              ...
              curSelected == 1
                ...
                //label: 'Home',
                label: "Search"/*Text('Search',style: TextStyle(color: Colors.black54))*/,
              )
                  :BottomNavigationBarItem(
              ...
              curSelected == 2
                ...
                //label: 'Home',
                label: /*Text('Favourite',style: TextStyle(color: Colors.black54))*/"Favourite",
              )
                  :BottomNavigationBarItem(
              ...
              curSelected == 3
                ...
                //label: 'Home',
                label: /*Text('Notification',style: TextStyle(color: Colors.black54))*/"Notification",
              )
                  :BottomNavigationBarItem(
                icon: SvgPicture.asset("assets/images/desel_notification.svg"),
                //label: 'Home',
                label:"Notification" /*Text('Notification',style: TextStyle(color: Colors.black54))*/,
              ),
              ...
              curSelected == 4
                ...
                //label: 'Home',
                label: /*Text('User',style: TextStyle(color: Colors.black54))*/"User",
              )
                  :BottomNavigationBarItem(
...
class StateHomePage extends State<HomePage> with TickerProviderStateMixin {
  ...
  Future<void> _showStartDialog() async {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          content: Text('Are you over 18 years?'),
          actions: <Widget>[
            TextButton(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 15),
                    //Text(SCROLLING_TEXT,style: TextStyle(color: Colors.white),),
                    SCROLLING_TEXT!=null&&SCROLLING_TEXT.isNotEmpty?
                    Container(
                      decoration: BoxDecoration(
                        border: Border(
                          top: BorderSide(
  ...
  goToCart() {
    Navigator.push(
        ...
        )).then((val) => widget.updateHomepage());
  }
  ...
  Future<void> getProduct(String id, int cur, String top) async {
    print("getPrduct : " + id.toString() + " | " + cur.toString() + " | " + top.toString());
    _isNetworkAvail = await isNetworkAvailable();
    if (_isNetworkAvail) {
      try {
        var parameter = {
  ...
  Widget productListItem(int tabIndex, int index, List<Product> subItem) {
    ...
    if (index < subItem.length) {
      ...
      print("New Length : " + index.toString() + " : " + _controller2[tabIndex].length.toString());

      if(_controller2[tabIndex].length < index + 1){
        _controller2[tabIndex].add(new TextEditingController());
        print("New Length : " + index.toString() + " : " + _controller2[tabIndex].length.toString());
      }
      // _controller2[sectionIndex][index].text = getQty(model);
      // _controller2[tabIndex][index].text =
      ...
      return subItem.length >= index
        ...
        child: Container(
          decoration: BoxDecoration(
            //color: Colors.teal,////313237
            // borderRadius: BorderRadius.all(
            //  Radius.circular(15),
            // ),
            // border: Border.all(
            //   color: Color(0xff1B9EC8),
            //   width: 3,
            // ),
            ...
            child: InkWell(
              ...
              child: Stack(
                children: [
                  ...
                  //     style: TextStyle(
                  //         fontSize: deviceHeight*0.0160,
                  //         color: colors.darkColor,//Color(0xffFED100),
                  //         decoration: TextDecoration.lineThrough
                  //     ),
                  //   ),
                  //
                  ...
                  ///for price
                  // Positioned(
                  //   top: deviceHeight * 0.203,
                  //   left: 30,
                  //   child: Container(
                  //     child: Row(
                  //       crossAxisAlignment: CrossAxisAlignment.center,
                  //       children: [
                  //         Text(CUR_CURRENCY.toString(),style: TextStyle(color: colors.darkColor,fontSize: deviceHeight*0.0200,fontWeight: FontWeight.bold),),
                  //         SizedBox(width: 2),
                  //         Text(price.toStringAsFixed(2) + " ", style: TextStyle(color: colors.darkColor,fontSize: deviceHeight*0.0200,fontWeight: FontWeight.bold),),
                  //   ],
                  //     ),
                  //   ),
                  // ),
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                //           color: colors.darkColor
                                //         ),
                                //         controller: _controller2[tabIndex][index],
                                //         decoration:
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.only(left: deviceWidth*0.0025,bottom: deviceHeight*0.0012),
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                            ...
                            Container(
                              // decoration: BoxDecoration(
                              //   color: Colors.transparent,//Color(0xffFFFFFF),//313237
                              //   // borderRadius: BorderRadius.all(
                              //   //  Radius.circular(15),
                              //   // ),
                              //   borderRadius: BorderRadius.only(
      ...
      if (_isNetworkAvail) {
        try {
          ...
          if (!error) {
            ...
            if(mounted)setState(() {subItem[index].isFav = "1";});
          } else {
            setSnackbar(msg);
          }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (!error) {
          ...
          subList = new List.from([new Product(id: "0", name: "Offers", offset: 0)])..addAll(catList); //[0].subList;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (!error) {
          ...
          String SCROLLING_TEXT = data["scrolling_news"].toString();
          if(SCROLLING_TEXT!=null)
            print("Scrolling text"+SCROLLING_TEXT.toString());
          if (del == "0")
            ISFLAT_DEL = true;
          else
            ISFLAT_DEL = false;
          if (CUR_USERID != null) {
            ...
            //CUR_CART_COUNT = getdata["data"]["user_data"][0]["total_items"].toString();
